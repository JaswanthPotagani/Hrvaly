def get_otp_template(otp_code: str):
    return f"""
    <div style="font-family: snas-serif; padding: 20px;">
...
def get_interview_report_template(user_name: str, score: float, tip: str):
    ...
    <div style="font-family: sans-serif; padding: 20px;">
      ...
      <a herf="https://yourdomain.com/dashboard" style="background: #f97316; color: white; padding:10px 20px; text-decoration: none; border-radius: 5px;">View Full Analysis</a>
    </div>
    """